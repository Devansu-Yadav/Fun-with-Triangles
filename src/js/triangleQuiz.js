...
const QuizAnswers = ["Scalene", "Equilateral", "5cm", "yes", "no", "yes", "20deg", "45deg", "30", "side CA"];
...
function calculateQuizScore() {
    ...
    output.innerHTML = "<p> Your total score: " + score + "<br> No of Correct Answers: " + score 
    + "<br>No of Incorrect Answers: " + (10 - score) + "</p>";
}
